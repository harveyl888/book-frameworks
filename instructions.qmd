...
Arrays can be specified using a hyphen and space as follows:
...
{yaml} can read in and convert a YAML file to an R list.  To convert the YAML above to a list use `yaml::yaml.load()` as follows:
